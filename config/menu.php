...
Menu::macro('sidebar', function () {
    return Menu::adminlteMenu()
        ...
        ->add(Menu::new()->prepend('<a href="#"><i class="fa fa-book"></i><span>Reportes</span> <i class="fa fa-angle-left pull-right"></i></a>')
            ...
            ->action('ReportsController@totalCondonation', '<i class="fa fa-money"></i><span>Condonacion</span>')
...
Menu::macro('sidebarAdmin', function () {
    return Menu::adminlteMenu()
        ...
        ->add(Menu::new()->prepend('<a href="#"><i class="fa fa-book"></i><span>Reportes</span> <i class="fa fa-angle-left pull-right"></i></a>')
            ...
            ->action('ReportsController@totalCondonation', '<i class="fa fa-money"></i><span>Condonation</span>')
            ->addClass('treeview-menu')
        )

        ...
        <div id="headerwrap">
            <div class="container">
                <div class="row centered">
                    ...
                    <div class="col-lg-8">
                        <img class="img-responsive" src="{{ asset('/img/JusticiaSocial1FByTW.jpg') }}" alt="">
                    </div>
                    <div class="col-lg-2">
                        <!-- <br>
                        ...
                        <div id="carousel-example-generic" class="carousel slide">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="{{ asset('/img/ParquePradosCondado.jpg') }}" alt="">
                                </div>
                                <div class="item">
                                    <img src="{{ asset('/img/JusticiaSocial1FByTW.jpg') }}" alt="">
                                </div>
                                <div class="item active">
                                    <img src="{{ asset('/img/ParquePradosCondado1.jpg') }}" alt="">
                                </div>
                                <div class="item active">
                                    <img src="{{ asset('/img/ParquePradosCondado2.jpg') }}" alt="">
                                </div>
